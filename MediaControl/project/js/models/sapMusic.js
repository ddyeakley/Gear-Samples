...
define({
    ...
    def: function modelsSAPMusic(e, sap) {
        ...
        e.listeners({
            'core.sap.service.connect.success': onConnection,
            'core.sap.service.connect.error': onConnectionError,
            'core.sap.device.attached': onDeviceAttached,
            'core.sap.music-mediachanged-rsp': onMediaChanged,
            'core.sap.music-setattribute-rsp': onSetAttribute
        });
